    ...
    return (
      <div className="about-us-container">
        ...
        <div className="about-us-description-box">
          ...
          social network for surfers. The idea is to meet with others surfer at the beach. <br/> You can post new events 
          and join other events. Also, you can know more about the beach where we will go surfing, rate the quality of 
